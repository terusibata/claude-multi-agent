...
BUILTIN_MCP_LABELS: dict[str, str] = {
    ...
    "mcp__file-tools__get_document_info": "Word文書情報",
    "mcp__file-tools__get_document_content": "Wordコンテンツ取得",
    "mcp__file-tools__search_document": "Word検索",
    "mcp__file-tools__get_presentation_info": "PowerPoint情報",
    "mcp__file-tools__get_slides_content": "PowerPointスライド取得",
    "mcp__file-tools__search_presentation": "PowerPoint検索",
